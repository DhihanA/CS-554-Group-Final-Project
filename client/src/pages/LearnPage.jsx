...
const LearnPage = () => {
    ...
    const link = 'https://gist.githubusercontent.com/jesalgandhi/5d0dddad0b3faf048990c534e5e98186/raw/12f54b265f69522b38660c31e8c561685d6769b7/piggyBankQuestions.json'
            ...
            {canAccessQuiz ? (
                <div className="card bg-base-300 shadow-xl my-4">
                    <form className="card-body">
                        ...
                        <button className="btn btn-primary mt-4" onClick={handleQuizSubmission}>
                            Submit
                        </button>
                    </form>
                </div>
              ...
              <div>
                <p className="text-center">You got {correctCount} {correctCount === 1 ? 'question' : 'questions'} correct!</p>
                <p className="text-center">Please wait before attempting the quiz again.</p>
                <p className="text-center">(work in progress... atm just refresh the page to get 2 other questions)</p>
              </div>
            )}
        </div>
      </>
