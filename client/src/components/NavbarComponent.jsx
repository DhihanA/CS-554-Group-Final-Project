...
export default function NavbarComponent() {
  ...
  return (
    <div className="navbar bg-base-100">
      ...
      {/* ICON to switch between valentine & forest mode  */}
      <div className="navbar-center hidden lg:flex">
        <label className="swap swap-rotate">
          {/* this hidden checkbox controls the state */}
          <input type="checkbox" onChange={handleToggle} checked={theme === "valentine"}/>
          {/* if valentine mode, show sun icon, otherwise show moon icon */}
          {theme === "valentine" ? (
